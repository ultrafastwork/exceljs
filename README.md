...
Using the `sheetImageId` returned from `worksheet.addImage` or `worksheet.addBackgroundImage`, an image can be removed from the worksheet.

```javascript
// Add an image and get its sheetImageId
